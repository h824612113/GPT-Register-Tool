...
| `scripts/macos/` | macOS operator scripts | Native-environment bootstrap, Python CLI launcher, and optional proxy-pool launcher | Keep scripts repository-relative; the WPF build and installer remain Windows-only. |
